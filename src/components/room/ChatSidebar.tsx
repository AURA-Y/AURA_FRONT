        ...
        <div className="flex gap-3">
          ...
          <div>
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-[10px] text-slate-500">오후 2:30</span>
            </div>
            <p className="text-sm text-slate-300">회의에 오신 것을 환영합니다! 👋</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#12131a] p-4">
        <div className="relative rounded-lg bg-[#20222b] px-4 py-2 ring-1 ring-white/5 focus-within:ring-indigo-500/50">
          ...
          <div className="mt-2 flex justify-end">
            <Button size="icon" className="h-6 w-6 rounded-full bg-indigo-500 hover:bg-indigo-600">
